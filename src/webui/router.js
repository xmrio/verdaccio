      ...
      <Router history={history}>
        <Fragment>
          ...
          <Switch>
            ...
            <Route exact={true} path={'/-/web/detail/@:scope/:package/:action'} render={this.renderVersionPage} />
            <Route exact={true} path={'/-/web/detail/:package/:action'} render={this.renderVersionPage} />
